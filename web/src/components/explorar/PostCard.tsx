          ...
          <Link href={`/profile/${post.user_id}`} className="flex flex-col items-center w-full group/content">
            <header className="flex flex-col items-center text-center w-full mb-2">
              <div className="relative mb-4 group">
                <div className="absolute inset-0 bg-[#f6339a] blur-2xl opacity-20 transition-opacity rounded-full"></div>
                <img src={avatarSrc} alt="" className="relative w-20 h-20 md:w-24 md:h-24 rounded-full object-cover border-2 border-[#f6339a]/30 p-1 shadow-[0_0_20px_rgba(246,51,154,0.4)] transition-transform duration-500 group-hover/content:scale-105" />
              </div>
        ...
        <div className="absolute bottom-6 right-3 flex flex-col items-center gap-6 z-20">
          <div className="relative mb-2">
            <Link href={`/profile/${post.user_id}`} className="relative block">
              <div className="absolute inset-0 bg-[#f6339a] blur-lg opacity-40 rounded-full"></div>
              <img src={avatarSrc} className="relative w-12 h-12 rounded-full object-cover border-[2.5px] border-[#f6339a]/50 shadow-[0_0_15px_rgba(246,51,154,0.5)] transition-transform hover:scale-110" alt="" />
            </Link>
            {!isOwnPost && !isFollowing && (
