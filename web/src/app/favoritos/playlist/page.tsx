        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="flex items-end gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 font-medium">Tus descubrimientos en MusicSwipe</p>
              </div>
            </div>
          ...
          {loading ? (
                ...
                <div key={song.id} className="group bg-[#1f1f1f] p-4 rounded-2xl shadow-sm hover:shadow-2xl transition-all border border-white/5 hover:border-[#f6339a]/30">
                  <div className="aspect-square rounded-xl overflow-hidden mb-4 relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="w-12 h-12 bg-[#f6339a] rounded-full flex items-center justify-center pl-1 shadow-lg transform scale-90 group-hover:scale-100 transition-transform">
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center bg-[#1f1f1f] rounded-[3rem] border border-dashed border-white/5">
              ...
              <p className="text-gray-500 max-w-xs mb-10">Empieza a descubrir canciones increíbles en MusicSwipe.</p>
